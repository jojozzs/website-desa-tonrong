// components/Galeri/GaleriClient.tsx
'use client'
  ...
  if (loading) {
    return (
      <div className="space-y-8">
        {/* Header Skeleton */}
        <div className="relative bg-gradient-to-br from-gray-100 via-white to-gray-100 rounded-2xl p-8 mb-8 overflow-hidden animate-pulse lg:min-h-100">
