    ...
    return (
        ...
        <div className="relative z-10 flex items-center h-full">
            ...
            <div className={`mb-8 overflow-hidden transform transition-all duration-1000 delay-300 ${
                ...
                <h2
                className={`text-5xl sm:text-4xl lg:text-8xl font-bold leading-tight transform transition-all duration-500 ${
            ...
            <div className={`min-h-40 mb-12 transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                <p className="text-xl lg:text-4xl text-gray-200 leading-relaxed max-w-3xl animate-fade-in" style={{ animationDelay: '1.2s' }}>
            ...
            <div className={`mb-12 transform transition-all duration-1000 delay-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                <div className="grid grid-cols-3 gap-8 lg:gap-12 max-w-2xl">
                <div className="text-center group animate-scale-in" style={{ animationDelay: '1.4s' }}>
                    ...
                    <div className="text-gray-300 font-bold text-sm lg:text-base">Jiwa Penduduk</div>
                </div>
                <div className="text-center group animate-scale-in" style={{ animationDelay: '1.6s' }}>
                    <div className="text-4xl lg:text-6xl font-bold text-white mb-2 group-hover:scale-110 transition-transform duration-300">
                    8
                    </div>
                    <div className="text-gray-300 font-bold text-sm lg:text-base">Dusun</div>
                </div>
                <div className="text-center group animate-scale-in" style={{ animationDelay: '1.8s' }}>
                    <div className="text-4xl lg:text-6xl font-bold text-white mb-2 group-hover:scale-110 transition-transform duration-300">
                    25
                    </div>
                    <div className="text-gray-300 font-bold text-sm lg:text-base">UMKM Aktif</div>
                </div>
                </div>
            </div>

            {/* CTA Buttons */}
            <div className={`flex flex-col sm:flex-row gap-4 max-w-3xl transform transition-all duration-1000 delay-900 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                <Link
                href="/profil"
                className="group flex-1 inline-flex items-center justify-center 
                px-8 py-4 text-lg sm:py-5 sm:text-xl lg:py-6 lg:text-2xl
                ...
                <ArrowRightIcon className="ml-3 h-5 w-5 sm:h-6 sm:w-6 lg:h-7 lg:w-7 group-hover:translate-x-1 transition-transform duration-200" />
                </Link>
