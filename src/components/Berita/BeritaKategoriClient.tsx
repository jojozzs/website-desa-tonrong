// components/Berita/BeritaKategoriClient.tsx
'use client'
...
interface BeritaKategoriClientProps {
  kategori: BeritaPengumumanKategoriEnum
}

export default function BeritaKategoriClient({ kategori }: BeritaKategoriClientProps) {
  ...
  return (
    <div className="space-y-6 container mx-auto px-6 md:px-8 lg:px-20 xl:px-40 py-4">
