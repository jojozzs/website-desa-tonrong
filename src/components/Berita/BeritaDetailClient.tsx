// components/Berita/BeritaDetailClient.tsx
'use client'
...
export default function BeritaDetailClient({ kategori, slug }: BeritaDetailClientProps) {
  const { data: berita, loading, error } = useBeritaBySlug(slug)
  
  // Fetch related articles dari kategori yang sama
  const { data: relatedArticles } = useBeritaData(kategori)
      ...
      <header className="bg-white shadow-sm border-b border-gray-200">
        ...
        <div className="">
          <div className="mx-auto">
            ...
            {/* Main Content */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 container mx-auto px-6 md:px-8 lg:px-20 xl:px-40 py-2">
