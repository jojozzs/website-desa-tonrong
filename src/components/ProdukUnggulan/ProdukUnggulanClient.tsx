// components/ProdukUnggulan/ProdukUnggulanClient.tsx
'use client'
...
export default function ProdukUnggulanClient() {
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {loading ? (
          ...
          <>
            ...
            {/* Empty state untuk halaman kosong */}
            {paginatedData.length === 0 && produkData.length > 0 && (
              <div className="text-center py-16">
