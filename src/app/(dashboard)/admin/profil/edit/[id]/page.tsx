...
import { FileText, MapPin, Target, Users, Building, History, Image as ImageIcon, Save, ArrowLeft, AlertCircle, Upload, Eye, Info, Clock, RefreshCw, Plus, Trash2, User } from 'lucide-react';
        ...
        <div className="min-h-screen bg-gray-50 p-4 lg:p-6">
            <div className="custom-max-width mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    {profil.kategori === ProfilKategoriEnum.STRUKTUR_PEMERINTAHAN_DESA && (
                    ...
                    {profil.kategori === ProfilKategoriEnum.JUMLAH_PENDUDUK_DAN_DATA_UMUM && (
                        <div className="space-y-8 text-gray-700">
                            {/* Data Demografi */}
                            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                                                        ...
                                                        onChange={(e) => {
                                                            setDataTambahan(prev => ({
                                                                ...
                                                                agama: {
                                                                    ...prev?.agama,
                                                                    [agama]: {
                                                                        persentase: prev?.agama?.[agama]?.persentase || 0,
                                                                        jumlah: parseInt(e.target.value) || undefined
                                                                    }
                                                                }
                                                            }));
                                                        }}
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <ul className="text-blue-700 text-sm space-y-1 leading-relaxed">
                                    ...
                                    {profil.kategori === ProfilKategoriEnum.STRUKTUR_PEMERINTAHAN_DESA && (
                                        <li>• Data pimpinan dan perangkat dapat ditambah/hapus sesuai kebutuhan</li>
                                    )}
                                    {profil.kategori === ProfilKategoriEnum.JUMLAH_PENDUDUK_DAN_DATA_UMUM && (
